...
> A state transition is valid only if it moves forward within a constrained window of the current state—everything else is rejected or treated as a boundary violation (desync).
