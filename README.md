...
[**`Oblivious Compute`**](https://github.com/ObliviousCompute/ObliviousCompute/README.md) **(OC)** is an open-source distributed computation primitive that determines correctness through admissibility rather than agreement and historical coordination.  
