...
Every wallet is a validator. Every node independently evaluates whether a proposed state transition is lawful. If it is not, it is rejected immediately. There is no coordination required to reject invalid state. It simply fails to exist.
...
Delay does not propagate. It dissipates.
