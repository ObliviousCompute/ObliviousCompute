...
along with reference material and example instantiations ***(Kernel, Skeleton, Hydra, Cerberus, and Byzantium)***.
...
No guarantees are made regarding correctness, fitness for purpose, or suitability for production use.

Oblivious Compute intentionally prioritizes **finality, simplicity, and erasure** over auditability, reversibility, or historical reconstruction.
Systems requiring long-term provenance or post-hoc inspection may not be appropriate candidates for this approach.

If the ideas presented here are incorrect, they are incorrect cleanly.  
If they are correct, they define a new design space.
