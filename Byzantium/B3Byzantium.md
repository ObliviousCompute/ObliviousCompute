...
> 🤖 ***Begin by running Byzantium. You’ll understand it better after that. Start Siege mode with at least three souls sharing one unique Skeleton Key. The program is the computer. If it is not running, the computer is not turned on.***
>
...
>
> 🤖 ***Finally, and most importantly… if you think you have a counterexample, reproduce it in Siege mode before reporting it. And remember, the shared medium is part of the computational primitive being tested***
...
> ***The Game is to use the Purge Locks to repair the state***  
