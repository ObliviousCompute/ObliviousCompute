...
**Appendix A** explores the [**`Implementations`**](./Appendecies/A.md) of Oblivious Compute, including the computational primitive, distributed operation, and adversarial behavior.

Read through **Appendix B** for the formal [**`Definitions`**](./Appendecies/B.md) used throughout the theory.

If you're interested in the underlying [**`Axioms`**](./Appendecies/C.md), finish with **Appendix C.**
