...
**Suppose every participant contributes to a field, yet no participant possesses it. In that case, the field can exist only in the relationships between participants.**
